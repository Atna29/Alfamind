...
Mobile.setText(findTestObject('Object Repository/Halaman Akun/Profile Saya/Ubah Password/Password Baru'), '123456', 5)

Mobile.setText(findTestObject('Object Repository/Halaman Akun/Profile Saya/Ubah Password/Confirm Password Baru'), '123456', 
    5)

Mobile.tap(findTestObject('Object Repository/Halaman Akun/Profile Saya/Ubah Password/Button Ajukan'), 5)

Mobile.verifyElementAttributeValue(findTestObject('Object Repository/Halaman Akun/Profile Saya/Ubah Password/Assert/Password berhasil dirubah'), 'text', 'Password berhasil dirubah', 5)
