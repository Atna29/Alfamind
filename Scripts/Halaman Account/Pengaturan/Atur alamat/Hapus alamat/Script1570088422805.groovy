...
Mobile.tap(findTestObject('Object Repository/Halaman Akun/Pengaturan/HAPUS'), 5)

Mobile.tap(findTestObject('Object Repository/Halaman Akun/Pengaturan/hapus - YA'), 5)
