...
Mobile.setText(findTestObject('Object Repository/Password/Email Anda'), 'test', 5)

Mobile.tap(findTestObject('Object Repository/Password/AJUKAN'), 5)

Mobile.verifyElementAttributeValue(findTestObject('Object Repository/Password/Assert/android.widget.TextView0 - Alamat Email tidak terdaftar') , 'text', '''Alamat Email tidak terdaftar
