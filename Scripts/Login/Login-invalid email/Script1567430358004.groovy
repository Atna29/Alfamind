...
Mobile.setText(findTestObject('Object Repository/LOGIN/android.widget.EditText1 - Password'), '121333', 10)

Mobile.takeScreenshot()

Mobile.tap(findTestObject('Object Repository/LOGIN/Login Button'), 10)

Mobile.verifyElementAttributeValue(findTestObject('Object Repository/LOGIN/Response/Masukkan alamat email yang benar'), 'text', 'Masukkan alamat email yang benar', 10)
